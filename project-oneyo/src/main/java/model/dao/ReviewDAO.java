...
public class ReviewDAO {
	...
	public List<Review> getAll(int mkId){
		...
		String sql = "SELECT r.reviewid, r.reviewwrites, o.orderdate, c.customername, m.mkid, c.customerid FROM review r, mealkitorder o, customer c, mealkit m, custommealkit cm "
