            ...
            <form name="form" class="col-md-9 m-auto" method="post" role="form" action="<c:url value='/customer/register' />">
                ...
                <div class="mb-3">
                  ...
                  <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
    				<input type="text" class="form-control mt-1" id="sample6_postcode" placeholder="우편번호">
				
					<input type="text" class="form-control mt-1" id="sample6_address" placeholder="주소"><br>
					<input type="text" class="form-control mt-1" id="sample6_detailAddress" placeholder="상세주소">
